...
public interface TrieInterface<T> {
     ...
     * @return Returns the last Trienode associated with the prefix. Eg: If PARIS and PARROT is in
     *     the Tries, searching for PAR, returns the trienode of first R
     */
     ...
     *                Eg: PAR and PARIS, printTrie(startWith("PAR")) should print PARIS and PARROT
     * i.e all the words with suffix PAR
     */
