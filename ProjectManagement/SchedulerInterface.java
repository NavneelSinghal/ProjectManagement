...
public interface SchedulerInterface {
    /**
     * @param cmd Handles Project creation. Input is the command from INP1 file in array format (use
     *     space to split it)
     */
    void handle_project(String[] cmd);

    /**
     * @param cmd Handles Job creation. Input is the command from INP1 file in array format (use
     *     space to split it)
     */
    ...
    /**
     * Add budget to a project Input is the command from INP1 file in array format (use space to
     * split it)
     *
     * @param cmd
     */
    ...
    /**
     * If there are no lines in the input commands, but there are jobs which can be executed, let
     * the system run till there are no jobs left (which can be run).
     */
     ...
     *    Return list of all Jobs for project <PROJECT> arriving at <T1> or later and at <T2> or
     earlier
     *
     ...
     *    Return list of all Jobs of user <USER> for project <PROJECT> arriving at <T1> or later and
     at <T2> or earlier.
     *    The list must be sorted in the order of job completion. Unfinished Jobs come last, and in
